	...
	return (
		<div className="space-y-6">
			...
			<p>
				...
				produits informatique. Nous vendons claviers, souris, écrans,...
			</p>
			<p>
				Ce projet est développé avec <strong>Next.js</strong>, un framework moderne basé sur
				React, permettant une expérience fluide et rapide.
			</p>
